...
int main() {
    ...
    cout << "Order: " << chocolateIceCream->getDescription()
         << ", Cost: " << chocolateIceCream->cost() << " yen" << endl;
    ...
    cout << "Order: " << caramelIceCream->getDescription()
         << ", Cost: " << caramelIceCream->cost() << " yen" << endl;

/*
    IPv4アドレスを表すクラス
    IPv4アドレスをキーボードから入力し、ディスプレイに出力する
    ユーザーは127.0.0.1や168.192.0.100のようなどっと形式で入力できなければならない
*/
...
class ipv4 {
    ...
    public:
        ...
        constexpr bool is_lookback() const noexcept {
        ...
        constexpr bool is_class_multicast() const noexcept {
